...
if __name__ == '__main__':
    ...
    list_VK_Photos = [['111111', 'photo_1,photo_2,photo_3'],
                      ['2222222', 'photo_1,photo_2,photo_3'],
                      ['3333333', 'photo_1,photo_2,photo_3']]
    # 3.Добавляем фото (partner_id, photo_link) в таблицу VK_Partners
    ...
    #
    #
    # 12.Получаем список (3 фото) из таблицы VK_Photos по partner_id (id партнера)
    partner_id = '111111'
